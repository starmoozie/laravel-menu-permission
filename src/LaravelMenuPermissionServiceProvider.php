...
namespace Starmoozie\LaravelMenuPermission;
...
class LaravelMenuPermissionServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->make('Starmoozie\LaravelMenuPermission\app\Http\Controllers\PermissionCrudController');
        $this->app->make('Starmoozie\LaravelMenuPermission\app\Http\Controllers\MenuCrudController');
        $this->app->make('Starmoozie\LaravelMenuPermission\app\Http\Controllers\RoleCrudController');
        $this->app->make('Starmoozie\LaravelMenuPermission\app\Http\Controllers\UserCrudController');
    }
    ...
    {
        $this->app->register(\Starmoozie\LaravelMenuPermission\app\Providers\MenuServiceProvider::class);
    }
